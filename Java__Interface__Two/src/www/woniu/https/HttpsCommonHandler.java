...
public class HttpsCommonHandler {
	...
	public String sendHttpsGet(String getUrl) {
		// TODO Auto-generated method stub
		String bodyTwo = "";
		String body = "";
		int i = 0;
	...
	public String sendHttpsPost(String postUrl, String postData) {
		// TODO Auto-generated method stub
		...
		try {
			...
			// 获取登录时的后面部分cookie
			// Map<String, List<String>> myCookieLogin=
