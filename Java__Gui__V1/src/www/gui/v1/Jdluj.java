...
public class Jdluj {
	...
	private void init() {
		...
		String temp= this.driver.findElement(By.xpath("/html/body/table/tbody/tr[1]/td[1]")).getText();//定位元素,绝对路径
		this.driver.findElement(By.xpath("//input[@id='username']")).clear();//定位元素, 相对路径
		this.driver.findElement(By.xpath("//input[@id='username']")).sendKeys("admin");//定位元素, 相对路径
		this.driver.findElement(By.xpath("//input[@id='password']")).clear();//定位元素, 相对路径
		this.driver.findElement(By.xpath("//input[@id='password']")).sendKeys("admin");//定位元素, 相对路径
